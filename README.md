...
* 'sqrt' - функция квадратного корня, в левом поддереве которой находится единственный аргумент вида 'Expression' (здесь должна быть ссылка на грамматику, но в общем здесь может быть любое выражение с мат. операциями, переменными, input())
